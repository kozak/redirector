...
ActiveRecord::Schema.define(version: 20150125150153) do
  ...
  add_index "redirect_rules", ["owner_id", "owner_type"], name: "index_redirect_rules_on_owner_id_and_owner_type", using: :btree
